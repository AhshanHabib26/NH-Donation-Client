...
export default function Footer() {
  return (
    <div className="mt-24">
      <div className="bg-gradient-to-r from-[#f7f6e8] to-[#def7f6] py-8">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            <div>
              <div className="flex items-center">
                <img
                  ...
                  alt=""
                />
                <h1 className="ml-2 text-xl font-semibold">WCD</h1>
              </div>
            ...
            <div>
              <h1 className={`${Styles.FooterTitle} text-xl font-semibold`}>
                Useful Links
              </h1>
              <ul className="mt-5">
                <Link
                  to="/"
                  className="text-lg cursor-pointer hover:text-[#D53F34] block"
                >
                  About Us
                </Link>
                <Link
                  to="/"
                  className="text-lg cursor-pointer hover:text-[#D53F34] my-1 block"
                >
                  Popular Causes
                </Link>
                <Link
                ...
                <div className="mt-3">
                  <form className="flex items-center">
                    ...
                    <input
                      type="submit"
                      value="Send"
                      className="w-[120px] h-[50px] bg-[#191F2D] text-lg text-white p-2 cursor-pointer rounded-r-lg"
                    />
                  </form>
                </div>
              </div>
          ...
          <hr className="my-6 border-gray-300 w-[80%] mx-auto" />
          <div className="flex items-center justify-center lg:justify-between flex-wrap">
            ...
            <div className="flex items-center">
              <h1 className="text-lg mr-2">Ways to Donate By: </h1>
